"""
COP Engine â PostgreSQL Persistence Layer
==========================================
Async PostgreSQL-lager med asyncpg.

Tabeller:
  - users          â autentisering & RBAC
  - schedules      â genererade scheman (JSON)
  - jobs           â solver-jobb (status tracking)
  - absence_chains â frÃ¥nvarokedjor
  - revoked_tokens â utloggade JWT-tokens
  - audit_log      â Ã¤ndringslogg

Fallback: om PostgreSQL inte Ã¤r tillgÃ¤nglig, anvÃ¤nds in-memory dicts.
"""
...
# Railway uses different variable names depending on setup
DATABASE_URL = (
